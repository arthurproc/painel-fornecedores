...
const membrosIniciais: Membro[] = [
  ...
  },
  {
    id: "m3",
    nome: "—",
    email: "operacoes@techminas.com.br",
    funcao: "visualizador",
    status: "pendente",
    desde: "10/04/2026",
  },
...
export default function FornecedorMembros() {
  ...
  return (
    <AppShell tipo="fornecedor" titulo="Membros da organização">
