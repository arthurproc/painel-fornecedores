...
export const TRIGGER_CATALOG: Record<string, TriggerDef> = {
  ...
  E8: { severidade: "importante", grupo_preferencia: "importantes_empresa", agrupavel: false, descricao: "Contrato encerrado aguardando review" },
  E9: { severidade: "informativa", grupo_preferencia: "informativas_tenant", agrupavel: false, descricao: "Review liberada" },
  ...
  F7: { severidade: "importante", grupo_preferencia: "importantes_fornecedor", agrupavel: false, descricao: "Contrato encerrado aguardando review" },
  F8: { severidade: "informativa", grupo_preferencia: "informativas_tenant", agrupavel: false, descricao: "Review da empresa liberada" },
  ...
  F14: { severidade: "importante", grupo_preferencia: "importantes_fornecedor", agrupavel: false, descricao: "Advisor comentou em entregável" },
  ...
  X2: { severidade: "informativa", grupo_preferencia: "informativas_tenant", agrupavel: false, descricao: "Identidade legal do tenant alterada" },
...
export const notificacoes: Notificacao[] = [
  ...
  },
  {
    ...
    corpo: "A review do contrato ct-30 ajuda a fortalecer o histórico de parceria da sua organização.",
  ...
  },
  {
    ...
    corpo: "Abra o formulário e envie a proposta formal da shortlist.",
  ...
  },
  {
    ...
    tipo: "E10",
    severidade: "informativa",
    titulo: "**Marina Queiroz** entrou no tenant",
  ...
  },
  {
    ...
    corpo: "Abra o workspace para começar a estruturar os entregáveis.",
